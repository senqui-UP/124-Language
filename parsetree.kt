sealed class ParseNode {
    sealed class StmtNode : ParseNode() {
        ...
        data class ReturnNode(val keyword: Token, val value: ExprNode?) : StmtNode()
    ...
    sealed class ExprNode : ParseNode() {
        ...
        data class CallNode(val callee: ExprNode, val paren: Token, val arguments: List<ExprNode>) : ExprNode()
    }
